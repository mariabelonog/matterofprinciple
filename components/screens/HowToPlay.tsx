...
// HowToPlay — экран с правилами игры: описание 7 шагов игрового цикла и ключевые формулы.
// Доступен с главного экрана и не является обязательным для прохождения.

// Пропсы экрана правил.
interface HowToPlayProps {
  onBack: () => void; // возврат на главный экран
}

// Массив шагов игрового цикла — отображается как пронумерованный список карточек.
const steps = [
  {
    num: "01",
